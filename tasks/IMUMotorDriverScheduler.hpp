...
#ifndef HEADS_LIVE_DEPLOYMENTS_IMUMOTORDRIVERSCHEDULER_TASK_HPP
#define HEADS_LIVE_DEPLOYMENTS_IMUMOTORDRIVERSCHEDULER_TASK_HPP

#include "heads_live_deployments/IMUMotorDriverSchedulerBase.hpp"

namespace heads_live_deployments{

    /*! \class IMUMotorDriverScheduler
     ...
     * The name of a TaskContext is primarily defined via:
     ...
     deployment 'deployment_name'
         task('custom_task_name','heads_live_deployments::IMUMotorDriverScheduler')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument.
     */
    class IMUMotorDriverScheduler : public IMUMotorDriverSchedulerBase
    {
	friend class IMUMotorDriverSchedulerBase;
    protected:
